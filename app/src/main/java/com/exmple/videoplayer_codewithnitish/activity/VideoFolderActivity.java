...
public class VideoFolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = getIntent().getStringExtra("folder_name");
        getFiles();
    ...
    private void getFiles() {
        ...
        if (name != null && videoModelArrayList.size() > 0) {
            fileAdapter = new VideoAdapter(videoModelArrayList, this);
            recyclerView.setAdapter(fileAdapter);
            recyclerView.setLayoutManager(new LinearLayoutManager(this, RecyclerView.VERTICAL, false));
        } else {
            Toast.makeText(this, "not found any files", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private ArrayList<VideoModel> getAllVideoFromFolder(Context context, String name) {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                duration_formatted += "  d=" +String.valueOf(duration);
